            ...
            <table class="min-w-full bg-white">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="py-2 px-4"><?php echo e($client->clientNo); ?></td>
                            <td class="py-2 px-4"><?php echo e($client->clientName); ?></td>
                            <td class="py-2 px-4"><?php echo e($client->placeOfDelivery); ?></td>
                            <td class="py-2 px-4"><?php echo e($client->contact); ?></td>
                            <td class="py-2 px-4">
                                <div class="flex justify-center items-center space-x-4">

                                    <!-- View Button (in the Actions column) -->
                                    <button id="openClientModalButton-<?php echo e($client->id); ?>" class="btn btn-primary"
                                        onclick="openClientViewModal(<?php echo e($client->id); ?>, <?php echo e(json_encode($client->deliveries)); ?>)">
                                    ...
                                    <a href="javascript:void(0);" class="text-blue-500 hover:text-blue-700"
                                        onclick="openEditModal(<?php echo e($client->id); ?>)">
...
<?php echo $__env->make('admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\TruckingMS\tms\resources\views/clients.blade.php ENDPATH**/ ?>