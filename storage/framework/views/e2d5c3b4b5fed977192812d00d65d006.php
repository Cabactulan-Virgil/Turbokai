    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
        <div class="bg-white p-4 rounded-lg shadow-md flex items-center">
            ...
            <div>
                ...
                <p class="text-lg font-bold"><?php echo e($totalTrucks); ?></p>
            </div>
        </div>
        <div class="bg-white p-4 rounded-lg shadow-md flex items-center">
        ...
        <div class="bg-white p-4 rounded-lg shadow-md flex items-center">
            ...
            <div>
                ...
                <p class="text-lg font-bold"><?php echo e($totalClients); ?></p>
            </div>
        </div>
        <div class="bg-white p-4 rounded-lg shadow-md flex items-center">
            ...
            <div>
                ...
                <p class="text-lg font-bold"><?php echo e($totalDeliveries); ?></p>
            </div>
        </div>
    </div>
    <br><br>
...
<table class="min-w-full divide-y divide-gray-200" id="statusTable">
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        <?php $__currentLoopData = $driverStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($status->driverName); ?></td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <?php if($status->status === 'In Trip' || $status->status === 'In Delivery'): ?>
...
<?php echo $__env->make('admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\TruckingMS\tms\resources\views/dashboard.blade.php ENDPATH**/ ?>