...
<body class="bg-gray-100">
    <div class="container mx-auto p-4">
        ...
        <div class="flex items-center space-x-4 mb-4">
            <a href="<?php echo e(route('delivery-index', ['status' => 'delivery'])); ?>"
                class="tab text-black <?php echo e($status === 'delivery' ? 'font-bold' : ''); ?>">Delivery</a>
            <a href="<?php echo e(route('delivery-index', ['status' => 'pending'])); ?>"
                class="tab text-black <?php echo e($status === 'pending' ? 'font-bold' : ''); ?>">Pending</a>
            <a href="<?php echo e(route('delivery-index', ['status' => 'onTheWay'])); ?>"
                class="tab text-black <?php echo e($status === 'onTheWay' ? 'font-bold' : ''); ?>">On the Way</a>
            <a href="<?php echo e(route('delivery-index', ['status' => 'delivered'])); ?>"
                class="tab text-black <?php echo e($status === 'delivered' ? 'font-bold' : ''); ?>">Delivered</a>
                    ...
                    <div class="grid grid-cols-3 gap-1">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="truck" name="truck_id" class="border border-gray-300 rounded p-2 w-full">
                                <?php $__currentLoopData = $trucks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $truck): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($truck->id); ?>"><?php echo e($truck->model); ?></option>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="client" name="client" class="border border-gray-300 rounded p-2 w-full">
                                <?php $__currentLoopData = $clientNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clientName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($clientName); ?>"><?php echo e($clientName); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="mb-3">
                            ...
                            <select id="assignDriver" name="driver" class="border border-gray-300 rounded p-2 w-full">
                                <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($driver); ?>"><?php echo e($driver); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="mb-4">
                            ...
                            <select id="licensePlate" name="licensePlate"
                                class="border border-gray-300 rounded p-2 w-full" required>
                                <?php $__currentLoopData = $licensePlates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $licensePlate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($licensePlate); ?>"><?php echo e($licensePlate); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="placeOfDelivery" name="location"
                                ...
                                <?php $__currentLoopData = $placesOfDelivery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $place): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div id="delivery" class="tabcontent <?php echo e($status === 'delivery' ? '' : 'hidden'); ?>">
            <br><button class="bg-gray-800 text-white py-2 px-4 mr-2" onclick="openModal()">Add Delivery</button>
        </div>

        <!-- Pending Tab -->
        <div id="Pending" class="tabcontent <?php echo e($status === 'pending' ? '' : 'hidden'); ?>">
            <br>
                    ...
                    <table class="min-w-full bg-white border border-gray-200">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $deliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delivery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="py-1 px-3"><?php echo e($delivery->doNo); ?></td>
                                    <td class="py-1 px-3"><?php echo e($delivery->dimension); ?></td>
                                    <td class="py-1 px-3"><?php echo e($delivery->pulloutDate); ?></td>
                                    <td class="py-1 px-3"><?php echo e($delivery->vanNo); ?></td>
                                    <td class="py-1 px-3"><?php echo e($delivery->client); ?></td>
                                    <td class="py-1 px-3"><?php echo e($delivery->driver); ?></td>
                                    <td class="py-1 px-3"><?php echo e($delivery->licensePlate); ?></td>
                                    <td class="py-1 px-3"><?php echo e($delivery->cargoDetails); ?></td>
                                    <td class="py-1 px-3"><?php echo e($delivery->location); ?></td>
                                    <td class="py-1 px-3"><?php echo e($delivery->returnDate); ?></td>
                                    <td class="py-1 px-3"><?php echo e($delivery->status); ?></td>
                                    <td class="py-1 px-3"><?php echo e($delivery->truckingFee); ?></td>
                                    <!-- Actions Section for Pending, On the Way, Delivered tabs -->
                                    <td class="py-1 px-3">
                                        <div class="flex space-x-2">
                                            <!-- Change status button -->
                                            <button class="bg-blue-500 text-white py-1 px-3 rounded"
                                                onclick="openStatusModal('<?php echo e($delivery->id); ?>', '<?php echo e($delivery->status); ?>')">
                                                <i class="fas fa-wrench"></i>
                                            </button>

                                            <!-- Edit Icon -->
                                            <button class="bg-yellow-500 text-white py-1 px-3 rounded"
                                                onclick="openEditModal('<?php echo e($delivery->id); ?>')">
                                                <i class="fas fa-edit"></i>
                                            </button>

                                            <!-- Delete Icon -->
                                            <!-- Delete Form -->
                                            <form action="<?php echo e(route('delivery.destroy', $delivery->id)); ?>" method="POST"
        ...
        <!-- On The Way Tab -->
        <div id="OnTheWay" class="tabcontent <?php echo e($status === 'onTheWay' ? '' : 'hidden'); ?>">
            <br>
            <div class="container mx-auto">
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white border border-gray-200">
        ...
        <!-- Delivered Tab -->
        <div id="Delivered" class="tabcontent <?php echo e($status === 'delivered' ? '' : 'hidden'); ?>">
            <br>
            <div class="container mx-auto">
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white border border-gray-200">
    ...
    <div id="statusModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden flex items-center justify-center">
        <div class="bg-white p-6 rounded-lg w-1/3">
            ...
            <form action="<?php echo e(route('delivery-update-status')); ?>" method="POST">
                <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-3 gap-1">
                ...
                <div class="mb-3">
                    ...
                    <select id="editTruck" name="truck_id" class="border border-gray-300 rounded p-2 w-full" required>
                        ...
                        <?php $__currentLoopData = $trucks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $truck): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($truck->id); ?>" <?php echo e(old('truck_id') == $truck->id ? 'selected' : ''); ?>>
                                <?php echo e($truck->model); ?>

                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <?php $__errorArgs = ['truck_id'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <select id="editClient" name="client" class="border border-gray-300 rounded p-2 w-full" required>
                        ...
                        <?php $__currentLoopData = $clientNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clientName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($clientName); ?>" <?php echo e(old('client') == $clientName ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <select id="editDriver" name="driver" class="border border-gray-300 rounded p-2 w-full" required>
                        ...
                        <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($driver); ?>" <?php echo e(old('driver') == $driver ? 'selected' : ''); ?>>
                                <?php echo e($driver); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <select id="editLicensePlate" name="licensePlate" class="border border-gray-300 rounded p-2 w-full"
                        ...
                        <?php $__currentLoopData = $licensePlates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $licensePlate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($licensePlate); ?>"
                                <?php echo e(old('licensePlate') == $licensePlate ? 'selected' : ''); ?>>
                                <?php echo e($licensePlate); ?>

                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <?php $__errorArgs = ['licensePlate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <select id="editPlaceOfDelivery" name="location"
                        ...
                        <?php $__currentLoopData = $placesOfDelivery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $place): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($place); ?>" <?php echo e(old('location') == $place ? 'selected' : ''); ?>>
                                <?php echo e($place); ?>
...
<?php echo $__env->make('admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\TruckingMS\tms\resources\views/delivery.blade.php ENDPATH**/ ?>