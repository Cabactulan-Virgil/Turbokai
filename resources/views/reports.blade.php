                        ...
                        <tbody>
                            @foreach($deliveries as $delivery)
                                <tr>
                                    ...
                                    <td class="px-4 py-2">{{ $delivery->licensePlate }}</td>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white border border-gray-200">
                ...
                <tbody>
                    ...
                    {{-- Loop through grouped deliveries --}}
                    @foreach($groupedDeliveriesByClient as $client => $deliveries)
                        {{-- Display the client name once --}}
                        <tr>
                            <td colspan="7" class="px-4 py-2 font-bold">{{ $client }}</td>
                        </tr>

                        {{-- Loop through each delivery for the client --}}
                        @foreach($deliveries as $delivery)
                            <tr>
                                ...
                                <td class="px-4 py-2">{{ $delivery->cargoDetails }}</td>
                                <td class="px-4 py-2">{{ $delivery->status }}</td>
                                <td class="px-4 py-2">{{ number_format($delivery->truckingFee, 2) }}</td>
                            </tr>
                            @php
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="px-4 py-2 font-bold">{{ number_format($totalFee, 2) }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
    ...
    <div class="container mx-auto">
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white border border-gray-200" id="deliveryTable">
                ...
                <tbody>
                    @foreach($groupedDeliveriesByLicensePlate as $licensePlate => $deliveries)
                        <tr class="bg-gray-200">
                            <td colspan="5" class="px-4 py-2 font-bold">{{ $licensePlate }}</td>
                        </tr>
                        @foreach($deliveries as $delivery)
                            <tr>
